...
CREATE TABLE IF NOT EXISTS `FAVORITES` (
    ...
    `id_start_station`	INTEGER NOT NULL,
    `id_end_station`	INTEGER NOT NULL,
    `name`	TEXT NOT NULL,
    FOREIGN KEY(`id_start_station`) REFERENCES `LINES`(`id`),
    FOREIGN KEY(`id_end_station`) REFERENCES `LINES`(`id`),
    PRIMARY KEY(`id`)
    );
...
INSERT INTO `FAVORITES` (id_start_station, id_end_station, name) VALUES (8012,8142, 'De brouckère vers Alma');
INSERT INTO `FAVORITES` (id_start_station, id_end_station, name) VALUES (8462,8432, 'Ribaucourt vers Rogier');
INSERT INTO `FAVORITES` (id_start_station, id_end_station, name) VALUES (8332,8412, 'Hotel vers Madou');
